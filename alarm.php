<?php 	
                ...
                */    
                ...
                {   
                   ...
                   $sql_string = 'EXEC dc_flashpoint_fire_alarm_update :id, 
                    ...
                    $dbh_pdo_statement->bindValue(':log_create', $_main_data->get_log_create(), \PDO::PARAM_STR);
                    $dbh_pdo_statement->bindValue(':log_create_by', $_main_data->get_log_create_by(), \PDO::PARAM_STR);
	...
	*/
    ...
    {   
        ...
        $_main_data = $dbh_pdo_statement->fetchObject('data_fire_alarm', array());
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <form class="" role="form" method="post" enctype="multipart/form-data">
                ...
                <fieldset id="fs_administration">
                	<legend>Administration</legend>
                
                    <div class="form-group row">
                            <label class="col-sm-2" for="status">Record Status <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                            
                            <!--Status: <?php echo $_main_data->get_status(); ?>-->
                            
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_<?php echo STATUS_SELECT::S_PRIVATE ?>" value="<?php echo STATUS_SELECT::S_PRIVATE ?>" <?php if($_main_data->get_status() == STATUS_SELECT::S_PRIVATE) echo ' checked ';?> required>
                                <label class="form-check-label" for="status_0">Private</label>
                            </div>
                            
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_<?php echo STATUS_SELECT::S_PUBLIC ?>" value="<?php echo STATUS_SELECT::S_PUBLIC ?>" <?php if($_main_data->get_status() == STATUS_SELECT::S_PUBLIC) echo ' checked ';?> required>
                ...
                <fieldset id="fs_metadata">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2" for="create_by">Created by <span class="text-danger">*</span></label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control"  name="create_by" id="create_by" placeholder="Person creating record." 
                            value="<?php echo $_main_data->get_log_create_by(); ?>" 
                            readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2" for="update_by">Last update by <span class="text-danger">*</span></label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control"  name="update_by" id="update_by" placeholder="Person last updating record." 
                            value="<?php echo $_main_data->get_log_update_by(); ?>" 
                            readonly>
                        </div>
                    </div>
