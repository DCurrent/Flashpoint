				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<div class="float-right">
						...
						<?php
							...
							{
						?>
								<a href="<?php echo $this->access_obj->get_member_config()->get_authenticate_url(); ?>?access_action=<?php echo \dc\stoeckl\ACTION::LOGOFF; ?>"><span class="glyphicon glyphicon-log-out"></span> <?php echo $this->access_obj->name_full(); ?></a>
						<?php
							}
							else
							{
